...
enum PlaceholderKind: String {
    ...
    case geolocationRestricted = "Press Appliction Settings button to allow geolocation for this application manually. Otherwise the app won't be able to show Your current location weather automatically"
}
